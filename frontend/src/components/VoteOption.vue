...
export default defineComponent({
	data() {
		return {
			entries: ["hate it", "dislike it", "neutral", "like it", "love it"],
			picked: 2,
		}
	},
	props: {
