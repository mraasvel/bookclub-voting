...
import { LinearScaleAnswer } from "src/form/linear_scale/linear_scale_submission.entity";
...
export default (configService: ConfigService): TypeOrmModuleOptions => ({
	...
	entities: [User, TypeORMSession, Poll, Vote, Form, FormQuestion, FormAnswer, LinearScale, LinearScaleAnswer],
	synchronize: true,
});
